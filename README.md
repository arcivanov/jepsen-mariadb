...
Jepsen tests for MySQL and MariaDB on Debian Trixie. You'll need [a Jepsen environment](https://github.com/jepsen-io/jepsen#setting-up-a-jepsen-environment) to run this test.
